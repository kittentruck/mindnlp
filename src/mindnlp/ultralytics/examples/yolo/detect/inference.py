...
from ultralytics.modeling_yolo import YOLO11ForObjectDetection

def main():
    parser = argparse.ArgumentParser(description="YOLO11 Object Detection Inference Pipeline")
    
    # --- 核心推理参数 ---
    parser.add_argument('--source', type=str, default='./datasets/coco128/images/train2017', help='待预测的图像或目录路径')
